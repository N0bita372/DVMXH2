...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($CMSNT->site('partner_id_card') == '' || $CMSNT->site('partner_key_card') == ''){
        die(json_encode(['status' => 'error', 'msg' => __('Chức năng nạp thẻ chưa được cấu hình')]));
    }
    ...
    if($data['status'] == 99){
        ...
        die(json_encode(['status' => 'error', 'msg' => $data['message']]));
    }
}
